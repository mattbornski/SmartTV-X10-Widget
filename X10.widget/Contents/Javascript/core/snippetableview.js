		...
		switch(event.payload.action) {
			case 'app-fav-add': 
				var dialog = new KONtx.dialogs.Alert({
					...
					message: "Would you like to add a snippet to the dock which will take you directly here in the future?",
					buttons: [
			...
			case 'app-fav-delete':
				var dialog = new KONtx.dialogs.Alert({
					...
					message: "Would you like to remove the snippet from the dock which you added which takes you directly to here?",
					buttons: [
						{ label: "Cancel" },
						{ label: "Ok", callback: (function() {
							this.removeSnippet();
